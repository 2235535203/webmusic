...
<body onbeforeunload="return end('creatorForm')">
<%
    int onepage=10;
%>
<script>
...
<br/>
<div style="font-size:25px">向乐库导入信息 当前:<span style="font-weight:bold">创作者</span></div>

<input type="button" value="歌曲" onclick='window.location="adm_music.jsp"'>
<input type="button" value="创作者" >
...
<div id="SingleInfoInput">
    ...
    <p>注意：如果信息只有姓名，且与库内信息相同，则服务器将视信息为冗余，并自动过滤</p>

    <form id="singleCreatorForm" action="${pageContext.request.contextPath}/servlet/UploadCreator" method="post" onsubmit="return uploadSingle('singleCreatorForm')">
        姓名<span style="color: red">*</span>:<input type="text" name="name" required>
        性别(可选):<input type="text" name="gender">
        国别(可选):<input type="text" name="country">
        地区(可选):<input type="text" name="area">
        备注(可选):<input type="text" name="remark">
        首字母<span style="color: red">*</span>:<input type="text" name="firstchar" required>
        <br/>
        <div class="kuang">
            头像地址:<input type="text" name="cover_address"><input type="file" name="cover" id="coverfileToUpload" onchange="fileSelected('cover')">
            <div class="preview">
            </div>
...
<div id="MultiInfoInput" style="display: none">
    ...
    <ol>
        ...
        %>
        <li>
            <form id="form<%=i%>" action="${pageContext.request.contextPath}/servlet/UploadCreator" method="post" onsubmit="return uploadSingle('form<%=i%>')">
                姓名<span style="color: red">*</span>:<input type="text" name="name" required><br/>
                性别(可选):<input type="text" name="gender"><br/>
                国别(可选):<input type="text" name="country"><br/>
                地区(可选):<input type="text" name="area"><br/>
                备注(可选):<input type="text" name="remark"><br/>
                首字母<span style="color: red">*</span>:<input type="text" name="firstchar" required><br/>
                头像地址:<input type="file" name="cover" ><br/>
                <input type="submit" value="提交">
                <input type="reset" value="清空">
            </form>
        </li>
