                   ...
                   // alert(jsonlength);
                    ...
                    for(var i = 0;i<jsonlength;i++){
                        str1 += "<tr class='myclass'>" +                         
                            ...
                            "<td>"+jsonobj[i].album_maker+"</td>" +
                            "<td>"+jsonobj[i].album_releseDate+"</td>" +
                            "<td>"+jsonobj[i].album_remark+"</td>" +
                            "<td hidden='hidden'>"+jsonobj[i].album_id+"</td>" +
...
$(document).ready(function(){
  ...
  $("#table_result").on('click','.playmusic',function(){
    ...
    var album_name=currentRow.find("td:eq(0)").html(); //获得当前和第一个表格单元格TD值
    var album_maker=currentRow.find("td:eq(1)").html(); //获得当前和第一个表格单元格TD值
    var album_releseDate=currentRow.find("td:eq(2)").html(); //获得当前和第一个表格单元格TD值
    var album_remark=currentRow.find("td:eq(3)").html();
    var album_id=currentRow.find("td:eq(4)").html();
    ...
    var musicjson= {
    	    ...
    	    "album_maker":album_maker, 
    	    "album_releseDate":album_releseDate,
           ...
           //几个参数需要注意一下
			...
			<div>
				...
				<ul id="navigation">
					...
					<li class="selected"><a href="search3.jsp">请输入专辑名</a></li>
				...
				<ul class="navigation">
	                ...
	                <div class="input-group">
			         <form method="post" name = "form1" id="search_form" >
				       ...
				       <input type="hidden" id="search_kind" name = "search_kind" value = "album_name">
					   	  </form>
