...
//action="Search" method="post"
		function search() {
			...
			var tbody = window.document.getElementById("tbody_result");//tablebody	
            $.ajax({
            //几个参数需要注意一下
    ...
    $.ajax({
        //几个参数需要注意一下
			...
			<div>
				...
				<ul id="navigation">
					<li class="selected"><a href="search1.jsp">请输入歌曲名</a></li>
				...
				<ul class="navigation">
	                ...
	                <div class="input-group">
			         <form name="search_form" id= "search_form">
				       ...
				       <input type="hidden" id="search_kind" name = "search_kind" value = "music_name">
	      			  </form>
